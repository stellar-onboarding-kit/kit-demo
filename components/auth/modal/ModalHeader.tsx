...
export const DefaultHeader: React.FC<{ setOpen: (open: boolean) => void }> = ({ setOpen }) => (
  <div className="w-full flex items-center justify-between p-2">
    <h2 className="text-lg font-semibold pl-3">Sign in</h2>
    <SecondaryButton onClick={() => setOpen(false)} className="size-[32px] rounded-full p-0 bg-card">
...
export const PageHeader: React.FC<{
  ...
  <div className="relative w-full flex items-center justify-between p-2">
    <SecondaryButton onClick={onBack} className="bg-card size-[32px] rounded-full p-0">
