...
export function FamilyStyleOTP() {
  ...
  return (
    <div className="w-full flex flex-col">
        ...
        <BaseOTPInput
          ...
          render={({ slots }) => (
            <div className="flex gap-2 items-center justify-between w-full">
              ...
              <div className="h-0.5 w-2 rounded-full bg-[#d4d4d4]" />
              <div className="flex gap-2 flex-1">
      ...
      <AnimatePresence>
        {errorMessage && (
          <motion.p
            ...
            exit={{ opacity: 0, y: -4 }}
            className="text-rose-400 text-xs text-center mb-2"
          >
            {errorMessage}
          </motion.p>
        )}
      ...
      {/* Resend */}
      <span className="text-neutral-500 mb-4 text-[13px] text-center py-2 pt-4">
      ...
      <button
        ...
        className="flex h-[40px] w-full items-center justify-center rounded-full font-semibold select-none transition-colors duration-200 ease-out active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 bg-blue-500 hover:bg-blue-600 data-[verifying=true]:bg-[#2A2A2A] data-[verifying=true]:text-[#b3b3b3]"
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="animate-spin">
                ...
                <path
                  ...
                  stroke="#191919" strokeOpacity="0.36" strokeWidth="3" strokeLinecap="round"
                />
              </svg>
              Verifying
            </motion.span>
